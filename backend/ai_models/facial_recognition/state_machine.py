...
class CaseStateMachine:
    ...
    VALID_TRANSITIONS = {
        'REPORTED': ['RAISED', 'UNDER_INVESTIGATION', 'ANALYZED', 'CLOSED'],
        'RAISED': ['UNDER_INVESTIGATION', 'ANALYZED', 'CLOSED'],
        'UNDER_INVESTIGATION': ['ANALYZED', 'MATCH_FOUND', 'NO_MATCH', 'CLOSED'],
        'ANALYZED': ['PENDING_CLOSURE', 'ESCALATED', 'UNDER_INVESTIGATION', 'CLOSED'],
