...
class CaseStateMachine:
    ...
    VALID_TRANSITIONS = {
        'REPORTED': ['RAISED', 'UNDER_INVESTIGATION', 'ANALYZED', 'ESCALATED', 'CLOSED'],
        'RAISED': ['UNDER_INVESTIGATION', 'ANALYZED', 'ESCALATED', 'CLOSED'],
        'UNDER_INVESTIGATION': ['ANALYZED', 'MATCH_FOUND', 'NO_MATCH', 'ESCALATED', 'CLOSED'],
        'ANALYZED': ['PENDING_CLOSURE', 'ESCALATED', 'UNDER_INVESTIGATION', 'MATCH_FOUND', 'CLOSED'],
        'ESCALATED': ['GOVERNMENT_REVIEW', 'CLOSED'],
        'GOVERNMENT_REVIEW': ['MATCH_FOUND', 'CLOSED'],
        'MATCH_FOUND': ['PENDING_CLOSURE', 'UNDER_INVESTIGATION', 'ANALYZED', 'ESCALATED', 'CLOSED'],
