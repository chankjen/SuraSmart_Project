"""
Django settings for SuraSmart backend.
...
ROOT_URLCONF = 'sura_smart_backend.urls'
...
# Internationalization - Prepare for multilingual support
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'UTC'
USE_I18N = True
USE_TZ = True
...
CELERY_BEAT_SCHEDULE = {
    'cleanup-old-uploads': {
        'task': 'facial_recognition.tasks.cleanup_old_uploads',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'sura_smart.log',
            'formatter': 'verbose',
        },
        'console': {
