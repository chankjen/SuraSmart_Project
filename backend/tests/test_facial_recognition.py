...
from ai_models.facial_recognition.views import _determine_hitl, _cosine_similarity, _compute_image_hash
...
class TestSessionClosureEndpoint:
    ...
    def test_close_with_no_match_action(self, family_client, family_user, sample_image_file):
        from ai_models.facial_recognition.models import SearchSession
        session = SearchSession.objects.create(
            user=family_user,
            uploaded_image=sample_image_file,
        )
